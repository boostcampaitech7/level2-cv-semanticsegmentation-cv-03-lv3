...
from .monai_unet import Monai_UNet
from .monai_unetplusplus import Monai_UNetplusplus
...
class ModelSelector():
    ...
    def __init__(self) -> None:
        self.model_classes = {
            "Unet" : UnetModel,
            "UNet using MONAI" : Monai_UNet,
            "UNetplusplus using MONAI" : Monai_UNetplusplus,
        }
